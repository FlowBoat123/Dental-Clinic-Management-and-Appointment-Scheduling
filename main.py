...
context_list = [
    ...
    # Niềng răng
    "Niềng răng là phương pháp chỉnh nha sử dụng mắc cài hoặc khay trong suốt để điều chỉnh vị trí răng.",
    "Niềng răng là quá trình sử dụng mắc cài hoặc khay trong suốt để điều chỉnh răng mọc lệch, chen chúc hoặc hô móm. Trung bình thời gian niềng răng từ 18 đến 24 tháng, tùy theo mức độ sai lệch của răng.",
]
